...
if __name__ == '__main__':
    ...
    # Load neural net
    checkpoint = torch.load('k-az10-1.pt', map_location=lambda device, loc: device)
    nnet = AlphaZeroChess()
    nnet.to(device)
    ...
    for i in range(int(args.start), int(args.end)):
        ...
        joblib.dump(data, './output/k-az10-1-wVSb-random-' + str(i) + '.joblib')
        outputxt = open("az_vs_randblack.txt", "a")
